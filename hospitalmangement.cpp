...
int main()
{
    ...
    while (cin >> op)
    {
        ...
        case 2:
            ...
            {
                cout << "\n\nEnter location where you want to delete a patient, at least 3 patients must be in list? \n\n";
                int l;
                cin >> l;
                delElement(head, l - 1);
        ...
        default:
            cout << "\n\nWrong option Selected . Please select the correct option" << endl;
        }
